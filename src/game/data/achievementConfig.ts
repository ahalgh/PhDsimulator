...
export const ACHIEVEMENTS: AchievementDefinition[] = [
    ...
    },
    {
        ...
        hint: 'Link GitHub, ORCID, Scholar, Tasks, or Calendar...',
        icon: '\u{1F517}',
        category: 'meta',
        tier: 'bronze',
    ...
    },
    {
        ...
        description: 'Connect all 5 data sources',
        hint: 'GitHub, ORCID, Scholar, Tasks, and Calendar -- the complete set...',
        icon: '\u{1F4A1}',
        category: 'meta',
        tier: 'gold',
        condition: { minDataSources: 5 },
        points: 50,
    },
];
